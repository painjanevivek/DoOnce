...
import type { RunRequest, WorkflowSpec, WorkflowStep } from "../../../contracts/protocol";
import type { ActionExecutionResult, ExecutorAdapter, ExecutorCapabilities } from "./executor-adapter";
...
class FakeAdapter implements ExecutorAdapter {
  ...
  public constructor(private readonly outcomes: Record<string, ActionExecutionResult> = {}) {}
